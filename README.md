...
This project consists of configuring a secure server using the HTTPS protocol in Apache, using self-signed certificates for the domain `discovery.system.sol`.
